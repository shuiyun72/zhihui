    ...
    <div class="vote_body">
      <el-row>
        ...
        <el-col :span="18" class="vote_body_right">
          ...
          <div class="item">
            <span class="red">*</span>
            <span class="title">投票详情</span>
            <el-input type="textarea" placeholder="请输入内容" v-model="textarea" maxlength="30"></el-input>
          </div>
          <div class="item">
            <span class="red">*</span>
