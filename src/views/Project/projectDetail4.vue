        ...
        <el-tabs type="border-card" class="part2 project_tabs_sy">
          <el-tab-pane label="商机分析">
            <div class="project_p3 jcs">
              ...
              <div class="right">
                <el-row v-for="(t,i) in 26" :key="i+'t1'" v-show="activeShow == '历史中标记录'">
                ...
                <el-row v-for="(t,i) in 6" :key="i+'t3'" v-show="activeShow == '历史招标甲方'">
                ...
                <div class="t_center" v-show="activeShow == '历史中标记录'">
